...
import 'package:s_w_eproject/pages/init_page/init_page_widget.dart';

import '../../pages/login/login_widget.dart';
import '../../pages/reservation3/reservation3_widget.dart';
import '/index.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => const InitPageWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          name: 'reservation2',
          path: '/reservation2',
          builder: (context, params) => const Reservation2Widget(),
        ),
        FFRoute(
          name: 'reservation3',
          path: '/reservation3',
          builder: (context, params) => const Reservation3Widget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
